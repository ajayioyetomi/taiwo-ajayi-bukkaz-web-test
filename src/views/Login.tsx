...
const Login = () => {
  return (
    <main className="p-4 sm:p-2 min-h-screen h-full sm:h-screen w-screen bg-black flex flex-col justify-center items-center">
      ...
      <section className="flex flex-col-reverse md:flex-row sm:min-w-163 gap-4 mt-4 justify-flex-start sm:justify-between sm:items-center">
        <div>
          <ol type="1" className="m-0 login-list" >
            <li>Open the logosum App on your phone</li>
            <li>Go to Profile → Settings</li>
            <li>Tap “Link TV Device</li>
            <li>
              <ul className="m-0">
                <li className="text-center"> Scan the QR Code displayed on your TV <br/> OR </li>
